...
Este documento proporciona contexto e información relevante para Codex al trabajar en el proyecto Amauta.
...
- ✅ **F3-005**: Endpoint crear evaluación (educador)
  - Endpoint `POST /evaluaciones` con validación Zod
  - Verificación de propiedad del curso en el servicio
  - Tests unitarios de controller y service
- ✅ **F3-006**: UI básica de crear evaluación
  - Página `/dashboard/evaluaciones/nueva` con formulario validado
...
- ✅ **F3-010**: Endpoint publicar/despublicar evaluación (educador)
  - Endpoint `PATCH /evaluaciones/:id/publicar`
  - Validación de propiedad/permiso
  - Actualización de `publicada` y `publicadoEn`
  - Tests unitarios de controller y service
- ✅ **F3-011**: UI detalle de evaluación (educador)
  - Página `/dashboard/evaluaciones/[id]` con datos principales
  - Proxy `GET /api/evaluaciones/:id` y estados loading/empty/error
  - Test básico de render del detalle
- ✅ **F3-012**: UI toggle publicar/despublicar evaluación
  - Acción de publicar/despublicar desde el detalle
...
- ✅ **F4-007**: API Asignación masiva de estudiantes a grupos
  ...
  - Auditoría básica en `GrupoEstudiante` para altas y remociones
  - Tests unitarios de controller y service
- ✅ **F4-008**: API Asignación de educadores a grupos
  - Endpoints `POST`, `GET` y `DELETE` en `/grupos/:id/educadores`
  - Endpoint `GET /educadores/me/grupos` para el panel del educador
  - Validación de institución, rol `EDUCADOR` y duplicados
  - Soft delete de asignaciones con posibilidad de reactivación
...
- ✅ Referencia de API (docs/technical/api-reference.md)
...
amauta/
├── README.md
├── AGENTS.md                    # Este archivo - Contexto para Codex
...
**Para migraciones y DB, seguir**: `ia-skills/development/prisma-db-management.md`
...
| Crear módulo CRUD completo          | `ia-skills/development/crud-generator.md`                                       |
| Agregar endpoint a módulo existente | `ia-skills/development/api-endpoint.md` + `docs/ai-context/modules/{modulo}.md` |
...
| **Skills**   | `ia-skills/`                         | Generadores de código           |
...
- `evaluaciones` - Evaluaciones (creación básica)

### Skills Disponibles

| Skill                     | Archivo                                          | Cuándo usar                                                                            |
| ------------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------- |
| **Prisma & DB**           | `ia-skills/development/prisma-db-management.md`  | Migraciones, verificar DB, resolver errores                                            |
| **CRUD Generator**        | `ia-skills/development/crud-generator.md`        | Crear módulo nuevo completo                                                            |
| **API Endpoint**          | `ia-skills/development/api-endpoint.md`          | Agregar endpoint a módulo existente                                                    |
| **React Form**            | `ia-skills/development/react-form.md`            | Crear formulario nuevo                                                                 |
| **Complete Issue**        | `ia-skills/automation/complete-issue.md`         | Ejecutar un issue completo de forma autónoma                                           |
| **Performance Review**    | `ia-skills/quality/performance-review.md`        | Analizar performance y generar informe con mejoras                                     |
| **Security Audit**        | `ia-skills/quality/security-audit.md`            | Auditar vulnerabilidades de seguridad (OWASP Top 10)                                   |
| **Fix Security Findings** | `ia-skills/quality/fix-security-findings.md`     | Aplicar fixes de un informe de auditoría previo (contexto limpio, build verificado)    |
| **NotebookLM Cuadernos**  | `ia-skills/capacitacion/notebooklm-cuadernos.md` | Generar cuadernos de estudio genéricos para NotebookLM                                 |
| **PWA Mobile Design**     | `ia-skills/specialized/pwa-mobile-design.md`     | Diseñar/auditar PWA orientada a mobile: manifest, SW, IndexedDB, sync, UI táctil       |
| **Feature Audit**         | `ia-skills/quality/feature-audit.md`             | Auditar que las features implementadas funcionan y cumplen sus criterios de aceptación |
