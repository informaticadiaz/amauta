...
> Documentación de los datos de prueba cargados en el sistema.
> Estos datos permiten probar todas las funcionalidades sin necesidad de crear contenido manualmente.

## Etapas del Seed

El seed se desarrolló en 5 etapas durante la Fase 0 del proyecto:
...
| calificaciones | 16        | 4 materias × 4 estudiantes      |
| comunicados    | 4         | Comunicados institucionales     |

## Credenciales de Prueba

Todos los usuarios usan la contraseña: `password123`

Ver [etapa-1-usuarios.md](etapa-1-usuarios.md) para la lista completa de emails y roles.
