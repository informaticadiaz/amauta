# Issue #43 — F1-016: Dashboard de estudiante

**Qué podés hacer ahora:** El dashboard principal de Amauta muestra un resumen personalizado de tu actividad de aprendizaje, con acceso rápido a tus cursos en progreso y sugerencias de nuevos cursos.
...
## Si sos educador o administrador, ahora podés:

- Ver un dashboard simplificado con acceso rápido a la gestión de cursos
- Acceder desde el botón "Ver mis cursos" a tu listado de cursos
