...
Crear `ia-skills/automation/loop-status.md` (dentro de la carpeta de la skill, autocontenido):
...
Las skills del agentic loop viven en `ia-skills/automation/` y son copias
independientes de las skills globales. No tocar `ia-skills/automation/complete-issue.md`.

Crear:

- `ia-skills/automation/complete-issue-automata.md` — copia de `complete-issue`
  con el template de commit sin atribución de IA y con PASO 12 de handoff al loop
- `ia-skills/automation/project-manager-automata.md` — copia de `project-manager-automata`
...
Leer `ia-skills/automation/project-manager-automata.md` para familiarizarse
...
```bash
git add ia-skills/automation/
git add docs/capacitacion/agentic-loops/

git commit -m "$(cat <<'EOF'
feat: infraestructura del agentic loop autónomo

- ia-skills/automation/: complete-issue-automata, project-manager-automata, loop-status.md
...
```
Sesión termina → escribe ia-skills/automation/next-prompt.md
...
```powershell
# loop-runner.ps1
$NextPrompt = "ia-skills/automation/next-prompt.md"
...
jobs:
  loop:
    ...
    steps:
      ...
      - run: cat ia-skills/automation/next-prompt.md | claude --print
```
...
[[ ! -f ia-skills/automation/next-prompt.md ]] && echo "OK" || echo "LOOP NO TERMINÓ"
```
...
El skill `loop-auditor` está en `ia-skills/automation/loop-auditor.md`.
...
| Archivo                                            | Propósito                             |
| -------------------------------------------------- | ------------------------------------- |
| `ia-skills/automation/project-manager-automata.md` | Skill orquestador del loop            |
| `ia-skills/automation/complete-issue-automata.md`  | Skill ejecutora del loop              |
| `ia-skills/automation/loop-auditor.md`             | Skill de auditoría                    |
| `ia-skills/automation/README.md`                   | Contexto del sistema                  |
| `ia-skills/automation/loop-status.md`              | Estado actual del loop                |
| `ia-skills/automation/next-prompt.md`              | Prompt de la próxima sesión (handoff) |
| `ia-skills/automation/audit-report-[fecha].md`     | Reportes de auditoría (Etapa 5+)      |
