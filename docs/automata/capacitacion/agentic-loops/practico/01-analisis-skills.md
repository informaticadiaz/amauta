...
Ubicación: `ia-skills/orchestration/project-manager.md`
...
Ubicación: `ia-skills/automation/complete-issue.md`
...
La variante resultante es `complete-issue-automata`, que vive en `ia-skills/automation/` junto con el orquestador.
...
1. **Las skills del loop** en `ia-skills/automation/` (`project-manager-automata`, `complete-issue-automata`, `loop-auditor`)
