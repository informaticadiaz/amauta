...
1. Actualizá `ia-skills/automation/loop-status.md` con el resultado de esta sesión
...
`ia-skills/automation/loop-status.md` es el único lugar donde el estado del loop persiste de forma legible. Cada sesión debe actualizarlo al inicio y al final.
