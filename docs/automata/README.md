...
Esta carpeta separa la referencia operativa del sistema actual, los disenos pendientes y el material de capacitacion. La implementacion viva de las skills no esta aca: vive en `ia-skills/automation/`.
...
2. `ia-skills/automation/README.md`
3. `ia-skills/automation/loop-status.md`
...
| Archivo                                            | Rol                                    |
| -------------------------------------------------- | -------------------------------------- |
| `ia-skills/automation/project-manager-automata.md` | Orquestador del loop                   |
| `ia-skills/automation/complete-issue-automata.md`  | Ejecutor de issues                     |
| `ia-skills/automation/loop-auditor.md`             | Auditor periodico                      |
| `ia-skills/automation/loop-runner.sh`              | Runner Linux/macOS                     |
| `ia-skills/automation/loop-runner.ps1`             | Runner Windows                         |
| `ia-skills/automation/loop-status.md`              | Log y estado del loop                  |
| `ia-skills/automation/next-prompt.md`              | Handoff efimero para la proxima sesion |
...
- Usar siempre `ia-skills/automation/loop-status.md` como path del log real del loop.
