...
```
Lee docs/ai-skills/crud-generator.md y genera un CRUD para el modelo
...
```
1. Lee docs/ai-skills/crud-generator.md
...
```
1. Lee docs/ai-skills/react-form.md
...
3. **Nuevo skill**: Crear en `docs/ai-skills/`
