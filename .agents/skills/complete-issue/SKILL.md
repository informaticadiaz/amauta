...
Seleccionar el issue de **menor número** que corresponda a la fase actual (según `AGENTS.md`).
...
- Fuentes de verdad actualizadas: AGENTS.md · roadmap.md · docs/sistema/README.md
