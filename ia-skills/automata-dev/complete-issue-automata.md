...
- Si está cerrado o tiene dependencias pendientes, registrar en `ia-skills/automata-dev/loop-status.md` y hacer STOP
...
- Si la implementación no se puede corregir de forma segura → STOP, registrar en `ia-skills/automata-dev/loop-status.md`, no escribir next-prompt.md
...
> Si TypeScript no compila → STOP, registrar en `ia-skills/automata-dev/loop-status.md`, no escribir next-prompt.md.
...
Escribir en `ia-skills/automata-dev/loop-status.md`:
...
Si la próxima sesión es `project-manager-automata`, escribir `ia-skills/automata-dev/next-prompt.md`:
...
Si la próxima sesión es `loop-auditor`, escribir `ia-skills/automata-dev/next-prompt.md`:
...
En cualquier STOP: registrar razón en `ia-skills/automata-dev/loop-status.md`.
...
- [ ] `ia-skills/automata-dev/loop-status.md` actualizado
- [ ] `ia-skills/automata-dev/next-prompt.md` escrito al final y sin commit (si condiciones cumplen) o STOP documentado
