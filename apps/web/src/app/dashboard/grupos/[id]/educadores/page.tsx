/**
 * Página de asignación de educadores a grupos
 */
...
import { GrupoEducadoresSection } from '@/components/grupos/GrupoEducadoresSection';
...
export default async function GrupoEducadoresPage({
  params,
}: {
